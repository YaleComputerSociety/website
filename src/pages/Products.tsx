...
import coursetablelogo from '../assets/products/CourseTable/coursetablelogo.png'
import coursetableheadimage from '../assets/products/CourseTable/headerimage.png'
...
export const Products = () => {
    ...
    return (
        ...
        <GeneralProduct 
            ...
            productColor="#006BBD" 
            productLogo={coursetablelogo}
            productSlogan="The best place to shop for classes at Yale." 
            headerImage={coursetableheadimage}
            isWeb
