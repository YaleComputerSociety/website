...
export const Team = () => {
  return (
    <div style={{ paddingTop: "10vh", backgroundColor: "white" }}>
      ...
      <div className="card-grid">
        {BOARD.slice(0, 7).map((board_member, i) => (
          <CardWrapper key={i}>
            <img src={board_member.image} alt={board_member.name} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", maxWidth: "200px", maxHeight: "200px" }} />
