...
const Join = () => {
  return (
    <div className="ml-32 mr-32">
      <h1 className="lg:text-8xl md:text-6xl sm:text-6xl text-6xl font-bold mt-10 text-ycs-pink mb-5">
        &lt;Come build with us /&gt;
      </h1>

      <p className="lg:text-4xl md:text-2xl sm:text-xl text-left mb-10">
        We are Yale&apos;s largest collective of software developers, product designers, and
        computer science enthusiasts. We&apos;re excited that you&apos;re interested in joining us!
      </p>
